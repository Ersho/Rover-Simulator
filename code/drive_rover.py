...
class RoverState():
    def __init__(self):
        ...
        self.stuck_time = None # ME To record total duration stuck time
        ...
        self.steering = 0 #ME While steering
        self.throttle = 0 # Current throttle value
        self.brake = 0 # Current brake value
        self.nav_angles = None # Angles of navigable terrain pixels
        self.nav_dists = None # Distances of navigable terrain pixels
        self.rock_angles = None #ME Angles of rocks pixels
        self.rock_dists = None #ME Distances of rocks pixels
        ...
        self.max_vel = 5.5 # Maximum velocity (meters/second)
        ...
        self.rover_been = [[103,187,0],[114,9,0]] #Me To store if Rover has visited corners
        self.check_pos = [[126,125],[102.5,73]] #Me To store if Rover goes to corners
        self.samples_pos = None # To store the actual sample positions
        self.samples_arr = [] #ME store array of located samples
